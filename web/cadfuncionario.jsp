            ...
            <div class="container">
                ...
                <form action="cadfuncionario.html" method="POST" id="cadfuncionario">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" id="cpffu" name="cpffun"  value="${funcionario.cpffunc}"/>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="complfu" name="complfun" value="${funcionario.complfunc}"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
