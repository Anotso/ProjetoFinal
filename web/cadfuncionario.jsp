    ...
    <body onload="CarregaCadFuncionario()">
        ...
        <div class="corpo">
            <div class="container">
                ...
                <c:if test="${not empty editaFuncionario}">
                    <c:forEach var="funcionario" items="${editaFuncionario}">
                        <form action="atualizafuncionario.html" method="POST" id="cadfuncionario">
                            <div class="form-group row">
                                <label for="nfu" class="col-md-4 col-form-label">ID do Funcionário:</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" id="nfu" name="idfun" value="${funcionario.idfuncionario}"/>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="nfu" class="col-md-4 col-form-label">Nome do Funcionário:</label>
